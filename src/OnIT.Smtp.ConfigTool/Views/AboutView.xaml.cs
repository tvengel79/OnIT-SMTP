...
{
    // Re-armed whenever the selection is cleared, so the easter egg can be found again by
    // anyone who deselects and reselects -- just not spammed on every intermediate step of
    // a single drag-to-select gesture.
